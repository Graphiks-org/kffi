...
/**
 * {@snippet lang=c : #define PROT_BTI 16
 */
fun PROT_BTI(): Int = (16).toInt()

/**
 * {@snippet lang=c : #define PROT_MTE 32
 */
fun PROT_MTE(): Int = (32).toInt()
...
/**
 * {@snippet lang=c : fcntl Int(Int,Int)
 */
private val fcntl_DESC: FunctionDescriptor = FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS)
private val fcntl_ADDR: MemorySegment = LOOKUP.find("fcntl").orElseThrow()
private val fcntl_HANDLE: MethodHandle = Linker.nativeLinker().downcallHandle(
    fcntl_ADDR, fcntl_DESC,
    Linker.Option.firstVariadicArg(2),
)

fun fcntl(arg0: Int, arg1: Int, arg2: MemorySegment, arg3: MemorySegment): Int {
    try {
        return fcntl_HANDLE.invokeExact(arg0, arg1, arg2, arg3) as Int
    } catch (ex: Error) {
        throw ex
...
/**
 * NS_ENUM: {@snippet lang=c : enum enum (unnamed at /usr/include/aarch64-linux-gnu/bits/eventfd.h:23:1)}
 */
enum class enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_eventfd_h_23_1_(val value: Long) {
    EFD_SEMAPHORE(1L), EFD_CLOEXEC(524288L), EFD_NONBLOCK(2048L);

    companion object {
        fun fromValue(v: Long): enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_eventfd_h_23_1_ = entries.firstOrNull { it.value == v }
            ?: error("Unknown enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_eventfd_h_23_1_ value: $v")
    }
}
...
/**
 * NS_ENUM: {@snippet lang=c : enum enum (unnamed at /usr/include/aarch64-linux-gnu/bits/confname.h:24:1)}
 */
enum class enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_confname_h_24_1_(val value: Long) {
    ...
    companion object {
        fun fromValue(v: Long): enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_confname_h_24_1_ = entries.firstOrNull { it.value == v }
            ?: error("Unknown enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_confname_h_24_1_ value: $v")
    }
}

/**
 * NS_ENUM: {@snippet lang=c : enum enum (unnamed at /usr/include/aarch64-linux-gnu/bits/confname.h:71:1)}
 */
enum class enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_confname_h_71_1_(val value: Long) {
    ...
    companion object {
        fun fromValue(v: Long): enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_confname_h_71_1_ = entries.firstOrNull { it.value == v }
            ?: error("Unknown enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_confname_h_71_1_ value: $v")
    }
}

/**
 * NS_ENUM: {@snippet lang=c : enum enum (unnamed at /usr/include/aarch64-linux-gnu/bits/confname.h:539:1)}
 */
enum class enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_confname_h_539_1_(val value: Long) {
    ...
    companion object {
        fun fromValue(v: Long): enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_confname_h_539_1_ = entries.firstOrNull { it.value == v }
            ?: error("Unknown enum_unnamed_at_usr_include_aarch64_linux_gnu_bits_confname_h_539_1_ value: $v")
    }
}
...
/**
 * {@snippet lang=c : #define O_DIRECTORY 16384
 */
fun O_DIRECTORY(): Int = (16384).toInt()

/**
 * {@snippet lang=c : #define O_NOFOLLOW 32768
 */
fun O_NOFOLLOW(): Int = (32768).toInt()
...
/**
 * {@snippet lang=c : #define O_DIRECT 65536
 */
fun O_DIRECT(): Int = (65536).toInt()
...
/**
 * {@snippet lang=c : #define O_TMPFILE 4210688
 */
fun O_TMPFILE(): Int = (4210688).toInt()
