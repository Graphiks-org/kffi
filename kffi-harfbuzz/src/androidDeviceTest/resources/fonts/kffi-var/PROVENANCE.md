...
This is the Android device-test copy of the fixture. It is byte-identical to
the JVM copy under
[`../../../../../jvmTest/resources/fonts/kffi-var/`](../../../../../jvmTest/resources/fonts/kffi-var/);
the generator path below is relative to this file's directory, which sits at
the same depth as the JVM copy.
