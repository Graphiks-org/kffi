 ...
 *
 * @property operatingSystem the normalized operating system (`macos`, `linux`, `android`).
 ...
 * that packaging does not expose the bytes. A consumer that needs a trustworthy digest must treat an
