...
allocator.close()
// JVM only: throws IllegalStateException: "MemoryBuffer has been closed"
scoped.writeLong(1L, 0uL)
// Android/Native: do not run this access after close; it is undefined behavior.
...
hotAllocator.close()
// JVM: throws IllegalStateException; the lifetime guard remains in unsafe mode.
// Android: do not run this access after close; it is undefined behavior.
hot.writeLong(2L, 0uL)
```
