...
/**
 * Kotlin/JVM wrapper for Objective-C class: GCControllerAxisInput
 * Superclass: GCControllerElement
 */
@PlatformAvailability(platform = "ios", introducedMajor = 7, introducedMinor = 0, introducedSubminor = -1)
@PlatformAvailability(platform = "macos", introducedMajor = 10, introducedMinor = 9, introducedSubminor = -1)
@PlatformAvailability(platform = "tvos", introducedMajor = 9, introducedMinor = 0, introducedSubminor = -1)
open class GCControllerAxisInput(override val ptr: MemorySegment) : GCControllerElement(ptr) {
    companion object {
        private val _class: MemorySegment by lazy { LOOKUP.let { ObjCRuntime.getClass("GCControllerAxisInput") } }
