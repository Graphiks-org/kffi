...
/**
 * Kotlin/JVM wrapper for Objective-C class: GCExtendedGamepadSnapshot
...
open class GCExtendedGamepadSnapshot(override val ptr: MemorySegment) : GCExtendedGamepad(ptr) {
    companion object {
        private val _class: MemorySegment by lazy { LOOKUP.let { ObjCRuntime.getClass("GCExtendedGamepadSnapshot") } }
