...
private val NSTextDidBeginEditingNotification_SEGMENT: MemorySegment by lazy { SymbolLookup.loaderLookup().find("NSTextDidBeginEditingNotification").orElseThrow().reinterpret(NSTextDidBeginEditingNotification_LAYOUT.byteSize()) }
...
private val NSTextDidEndEditingNotification_SEGMENT: MemorySegment by lazy { SymbolLookup.loaderLookup().find("NSTextDidEndEditingNotification").orElseThrow().reinterpret(NSTextDidEndEditingNotification_LAYOUT.byteSize()) }
...
private val NSTextDidChangeNotification_SEGMENT: MemorySegment by lazy { SymbolLookup.loaderLookup().find("NSTextDidChangeNotification").orElseThrow().reinterpret(NSTextDidChangeNotification_LAYOUT.byteSize()) }
