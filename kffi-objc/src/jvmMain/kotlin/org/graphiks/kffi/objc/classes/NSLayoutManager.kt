...
open class NSLayoutManager(override val ptr: MemorySegment) : NSObject(ptr) {
    ...
    open fun showCGGlyphs_positions_count_font_textMatrix_attributes_inContext(glyphs: MemorySegment, positions: MemorySegment, glyphCount: Long, font: MemorySegment, textMatrix: MemorySegment, attributes: MemorySegment, CGContext: MemorySegment): Unit {
        ...
        ObjCRuntime.msgSend(null, ptr, sel, glyphs, positions, glyphCount, font, ObjCRuntime.ObjCStructArg(textMatrix, MemoryLayout.structLayout(ValueLayout.JAVA_DOUBLE.withName("a"), ValueLayout.JAVA_DOUBLE.withName("b"), ValueLayout.JAVA_DOUBLE.withName("c"), ValueLayout.JAVA_DOUBLE.withName("d"), ValueLayout.JAVA_DOUBLE.withName("tx"), ValueLayout.JAVA_DOUBLE.withName("ty")).withName("CGAffineTransform")), attributes, CGContext)
    }
